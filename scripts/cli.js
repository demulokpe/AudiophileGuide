...
const contractABI = require("../artifacts/contracts/Audiophileguide.sol/Audiophileguide.json").abi;

program
    .name("audiophileguide-cli")
    .description("CLI tool for Audiophileguide smart contract")
    .version("1.0.0");
